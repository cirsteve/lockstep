...
# Substrings that are obvious reach-arounds and aren't needed by any
# legitimate solver. Cheap surface check; the real isolation is a
# subprocess sandbox in production.
